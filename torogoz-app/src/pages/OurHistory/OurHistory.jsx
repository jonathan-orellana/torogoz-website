...
export function OurHistory() {
  ...
  useEffect(() => {
    document.body.classList.add('page--our-history');
    return () => document.body.classList.remove('page--our-history');
  }, []);
  ...
  return (
    <main>
      <PageHero
        ...
        imageSrc={assetUrl("/assets/images/liviston-college.png")}
      ...
      <MeaningSection
        ...
        imageSrc={assetUrl("/assets/logos/lsu-logo.png")}
      ...
      <LegacySection
        title={
          <>
            Built on <span className="accent">brotherhood</span>
          </>
        }
        ...
        imageSrc={assetUrl("/assets/images/brothers.png")}
